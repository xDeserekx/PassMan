...
namespace PassManTests.Encryption.PasswordValidator
{
    public class ValidatePasswordsTests
    {
        ...
        {
            Assert.True(PassManLib.PasswordValidator.ValidatePassword("Abc123%^&&2145"));
        }
        ...
        {
            Assert.False(PassManLib.PasswordValidator.ValidatePassword(item));
        }
        ...
        {
            Assert.Equal(expected, PassManLib.PasswordValidator.ValidatePassword(append + "Abc152362cdevr34eGR"));
        }
        ...
        {
            Assert.Equal(expected, PassManLib.PasswordValidator.ValidatePassword(append + "agvrberer&%*$bnNDNR"));
        }
        ...
        {
            Assert.Equal(expected, PassManLib.PasswordValidator.ValidatePassword(append + "agrekjjger£$^&£&$%23235"));
        }
        ...
        {
            Assert.Equal(expected, PassManLib.PasswordValidator.ValidatePassword(append + "AVBDSG65346346@^£$$"));
        }
    }
}
