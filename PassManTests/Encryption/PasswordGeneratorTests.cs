...
namespace PassManTests.Encryption
{
    public class PasswordGeneratorTests
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => PassManLib.PasswordGenerator.GeneratePassword(length));
        }
        [Fact]
        public void Ensure_if_we_do_not_use_any_char_types_we_are_told_about_it()
        {
            Assert.Throws<ArgumentException>(() => PassManLib.PasswordGenerator.GeneratePassword(33, false, false, false, false));
        }
        ...
        {
            var password = PassManLib.PasswordGenerator.GeneratePassword(length);
        ...
        {
            var password = PassManLib.PasswordGenerator.GeneratePassword(20, true, false, false, false);
        ...
        {
            var password = PassManLib.PasswordGenerator.GeneratePassword(20, false, true, false, false);
        ...
        {
            var password = PassManLib.PasswordGenerator.GeneratePassword(20, false, false, true, false);
        ...
        {
            var password = PassManLib.PasswordGenerator.GeneratePassword(20, false, false, false, true);
        ...
        {
            var password = PassManLib.PasswordGenerator.GeneratePassword(20);
